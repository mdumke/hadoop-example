...
As per the [official guide](https://hadoop.apache.org/docs/stable/hadoop-project-dist/hadoop-common/SingleCluster.html), Hadoop can be installed in a *pseudo-cluster* mode.
